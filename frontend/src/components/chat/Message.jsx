    ...
    <div
      ...
      className={cn(
        ...
        !simplified && replyingTo?.id === message.id
          ...
          : !simplified && "focus-within:bg-muted hover:bg-muted",
      )}
    >
      {!simplified && (message.reply_to_message || message.is_pinned) && (
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Reactions - hidden in simplified mode */}
          {!simplified && message.reactions && message.reactions.length > 0 && (
